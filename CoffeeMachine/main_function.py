...
def check_resources(order_ingredients):
    """Returns True if there are enough ingredients in the machine to make the requested drink, False if there aren't."""
...
def make_coffee(order_ingredients):
    """Subtracts ingredients used up for the drink from the in the machine, adds cost of drink to machine counter."""
    for item in order_ingredients:
...
while switch_off == False:
    ...
    while not choice == "report" and not choice == "off" and not choice == "espresso" and not choice == "latte" \
    and not choice == "cappuccino":
